...
first install Node.js and dependencies as below.

> npm install
> npm install -g bower --save

Setup a local MySql instance and run supplied "database.sql"
...
Now if you submit data over post to http://localhost:3000/exposed it will inreal time update the graph which is done using Angular-charts 
